...
#ifndef WALLET_CONTROLLER_HPP_laiin
#define WALLET_CONTROLLER_HPP_laiin
...
class WalletController : public QObject, public monero_wallet_listener
{
    ...
    Q_PROPERTY(laiin::Wallet* wallet READ getWallet NOTIFY walletChanged);
...
public:
    ...
    Q_INVOKABLE laiin::Wallet * getWallet() const;
...
private:
    std::unique_ptr<laiin::Wallet> _wallet;
