...
#ifndef ESCROW_HPP_laiin
#define ESCROW_HPP_laiin
...
struct Escrow {
    static void test_multisig_participants(const std::vector<laiin::Wallet *>& participants, int M, int N, bool test_tx);
