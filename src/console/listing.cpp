...
laiin::Listing& Listing::operator=(const laiin::Listing& other)
{
    if (this != &other) {
        id = other.id;
...
laiin::Listing& Listing::operator=(laiin::Listing&& other) noexcept
{
    if (this != &other) {
...
laiin::Product * Listing::get_product() const {
    return product.get();
}
