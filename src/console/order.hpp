...
#ifndef ORDER_HPP_laiin
#define ORDER_HPP_laiin
...
public:
	...
	~Order();
	void create_order(const laiin::Cart& cart, const std::string& shipping_address);
...
private:
	...
	void create_order_batch(const laiin::Cart& cart, const std::string& shipping_address);
};
