...
#ifndef CART_HPP_laiin
#define CART_HPP_laiin
...
public:
	...
	laiin::Product * get_item(unsigned int index) const; //unsigned int get_id() const;//static std::string get_file();
	std::vector<std::shared_ptr<laiin::Product>> get_contents_list() const;
    // getters - user
