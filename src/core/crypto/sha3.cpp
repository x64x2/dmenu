...
std::string sha3_256(const std::string& plain_text) {
    ...
    if(context == nullptr) { laiin::print("EVP_MD_CTX_new failed", 1); return ""; }
...
int main() {
    std::cout << laiin::crypto::sha3_256("Turtles are cool") << "\n\n";
    std::cout << laiin::crypto::sha3_512("Turtles are cool") << "\n";
    return 0;
