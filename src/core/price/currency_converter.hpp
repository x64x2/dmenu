...
#ifndef CURRENCY_CONVERTER_HPP_laiin
#define CURRENCY_CONVERTER_HPP_laiin
...
public:
    ...
    static double get_price(laiin::Currency from, laiin::Currency to);
    ...
    static laiin::Currency get_currency_enum(const std::string& currency);
    // boolean
