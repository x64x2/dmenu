...
ApplicationWindow {
    ...
    title: qsTr("laiin" + " v" + laiinVersion)
    ...
    header: Rectangle {
        color: laiinComponents.Style.getColorsFromTheme()[1]
        ...
        Button {
            id: laiinLogoImageButton
            visible: !settingsDialog.hideHomepageButton
            property real iconSize: 30
            icon.source: (laiinComponents.Style.darkTheme) ? "qrc:/assets/images/appicons/Vector_Illustrator Files/LogoLight.svg" : "qrc:/assets/images/appicons/Vector_Illustrator Files/LogoDark.svg"
        ...
        laiinComponents.SearchBar {
            id: searchBar
            anchors.left: (laiinLogoImageButton.visible) ? laiinLogoImageButton.right : parent.left
            anchors.leftMargin: 20
            anchors.top: parent.top; anchors.topMargin: 20        
        }    

        laiinComponents.NavigationalBar {
            id: navBar
    ...
    laiinComponents.SettingsDialog {
        id: settingsDialog
        ...
        Row {
            ...
            Rectangle {
                ...
                Button {
                    ...
                    icon.color: (laiinComponents.Style.darkTheme) ? "#8fa4ff" : "#001677"////hovered ? "#001677" : "#ffffff"//(!checked && hovered) ? "#001677" : "#ffffff"
            ...
            Rectangle {
                ...
                laiinComponents.ProgressBar {
                    ...
                    foregroundColor: laiinComponents.Style.moneroOrangeColor
                    backgroundColor: daemonSyncBar.backgroundColor//(laiinComponents.Style.darkTheme) ? "#8c8c8c" : laiinComponents.Style.moneroGrayColor
                    //textObject.visible: true
