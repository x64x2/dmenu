...
CheckBox {
    ...
    property int shapeType: laiinComponents.CheckBox.ShapeType.Check
    ...
    indicator: Rectangle { // This is the actual visual CheckBox or its background, you could say
        ...
        Rectangle {
            ...
            visible: control.checked && (control.shapeType == laiinComponents.CheckBox.ShapeType.Block)
        }
        // or
        Text {
            text: qsTr("\uf00c")
            ...
            anchors.centerIn: parent
            color: control.down ? "#443a5f" : "#4d426c"
            visible: control.checked && (control.shapeType == laiinComponents.CheckBox.ShapeType.Check)
        }
    }
