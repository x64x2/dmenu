...
GridView {
    ...
    delegate: Rectangle { // delegates have a readonly "index" property that indicates the index of the delegate within the repeater
        ...
        color: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#17171c" : "#181a1b") : "#c9c9cd"//"#e6e6e6"//"#f0f0f0"
        ...
        Rectangle {
            ...
            color: "#ffffff"//"transparent"//(laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
        ...
        Image {
            ...
            source: "qrc:/assets/images/paid.png"//laiinResourceDir + "/paid.png"
            ...
            Rectangle {
                ...
                Row { 
                    ...
                    Text {
                        ...
                        color: "#4169e1"//(laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        font.pointSize: 10
                    }
                }
                laiinComponents.Hint {
