...
Item {
    ...
    property string columnBorderColor: (laiinComponents.Style.darkTheme) ? "#404040" : "#4d4d4d"
    property string columnColor: listView.cellColor//"transparent"//(laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#0e0e11" : "#101010") : "#f0f0f0"////"transparent"//"#6c6c6f"
    ...
    ColumnLayout {
        ...
        ListView {
            ...
            property string cellColor: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#17171c" : "#181a1b") : "#c9c9cd"//"transparent"//table.columnColor
            //property int currentSorting: 0
            ////contentHeight: childrenRect.height
            ////Component.onCompleted: console.log(laiin.InventorySorting) // C++ enum
                    ...
                    Item {
                        ...
                        TextField {
                            ...
                            background: Rectangle { 
                                color: "transparent"
                                border.color: !parent.readOnly ? ((laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000") : "transparent"
