            ...
            delegate: Item {
                ...
                RowLayout {
                    ...
                    Label {
                        id: nodeAddressLabel
                        Layout.fillWidth: true
                        text: (typeof modelData === "string") ? modelData : modelData.address//"node.laiin.org:38081"//:18081"
                        color: delegateRow.parent.ListView.isCurrentItem ? "#471d00" : ((laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000")
