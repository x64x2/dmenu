...
Item {
    ...
    Button {
        ...
        icon.source: "qrc:/assets/images/search.png"//laiinResourceDir + "/search.png"
        icon.color: "#ffffff"
    ...
    Popup {
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                color: hovered ? laiinComponents.Style.getColorsFromTheme()[1] : laiinComponents.Style.getColorsFromTheme()[0]
