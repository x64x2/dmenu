...
import laiin.CurrencyExchangeRates 1.0
...
Popup {
    ...
    function save() { 
        const settings_obj = {
            ...
            dark_theme: laiinComponents.Style.darkTheme,//(themeBox.currentText != "DefaultLight"),
            ...
            // paths
            wallet_directory: (Script.getJsonRootObject()["wallet_directory"].length > 0) ? Script.getJsonRootObject()["wallet_directory"] : laiinDefaultWalletDirPath,
        };
        
        const settings_json = JSON.stringify(settings_obj);
        //console.log("Settings changed: ")
        //console.log("Saving to ", laiinDataDirPath + "/settings.json")
    ...
    background: Rectangle {
        implicitWidth: 700
        implicitHeight: 500
        color: laiinComponents.Style.getColorsFromTheme()[2]
        ...
        TabBar {
            ...
            TabButton { 
                ...
                contentItem: Text {
                    text: parent.text
                    color: (parent.checked) ? "#ffffff" : ((laiinComponents.Style.darkTheme) ? "#e0e0e0" : "#353637")//"#000000" : "#ffffff"
            ...
            TabButton { 
                ...
                contentItem: Text {
                    text: parent.text
                    color: (parent.checked) ? "#ffffff" : ((laiinComponents.Style.darkTheme) ? "#e0e0e0" : "#353637")
                    horizontalAlignment: Text.AlignHCenter
                    verticalAlignment: Text.AlignVCenter                    
                    font.bold: true
                    //font.family: FontAwesome.fontFamily
    ...
    ScrollView {    
        ...
        StackLayout {
            ...
            property string contentBoxBorderColor: (laiinComponents.Style.darkTheme) ? "#f0f0f0" : "#4d4d4d"//"#030380"
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        laiinComponents.ComboBox {
                            ...
                            color: "#f2f2f2"//(laiinComponents.Style.darkTheme) ? "#101010" : "#f0f0f0"
                            //textColor: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        }
                    }
                    // Price API - TODO
                    /*Item {
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        laiinComponents.ComboBox {
                            ...
                            anchors.right: parent.right//Layout.alignment: Qt.AlignRight; Layout.rightMargin: 0
                            width: settingsStack.comboBoxWidth
                            currentIndex: model.indexOf(Script.getJsonRootObject()["theme"])//Component.onCompleted: currentIndex = model.indexOf(laiinComponents.Style.themeName) // Set the initial currentIndex to the index in the array containing themeName string
                            displayText: currentText
                            ...
                            onActivated: {
                                if(currentText == "PurpleDust") {
                                    laiinComponents.Style.darkTheme = true
                                ...
                                if(currentText == "DefaultLight") {
                                    laiinComponents.Style.darkTheme = false
                                    lastUsedLightTheme = currentText
                                }
                                laiinComponents.Style.themeName = currentText//displayText // update the actual theme (name)
                                themeSwitcher.checked = !laiinComponents.Style.darkTheme // update the theme switch                           
                                ...
                                : change theme in configuration file too
            ...
            ColumnLayout {
                ...
                //rowSpacing:  // The default value is 5 but we'll set this later
                    ...
                    RowLayout {
                        ...
                        //spacing: 5
                        property string checkedColor: laiinComponents.Style.moneroOrangeColor////"#0069d9"
...
Item {
        ...
        spacing: 5
            Frame {
                    ...
                    background: Rectangle {
                        radius: 3
                        color: "transparent"
                        border.color: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#7d7d97" : "#a8a8a8") : "#989999"
                        //border.width: 1
                    }

                laiinComponents.NodeList {
                ...
                RowLayout {
                    ...
                    TextField {
                        ...
                        placeholderText: qsTr("Custom node IP address"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                        color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        selectByMouse: true
                
                        background: Rectangle { 
                            color: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#4b4751" : "#4c4c4c") : "#ffffff"
                            border.color: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                            radius: 3
                        }
                    }
                    ...
                    TextField {
                        ...
                        placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                        color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        selectByMouse: true
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            color: !remoteNodeConnectButton.enabled ? laiinComponents.Style.disabledColor : laiinComponents.Style.moneroOrangeColor
                            radius: 3//6
                        }
                        contentItem: Text {
                            text: parent.text
                ...
                RowLayout {
                    ...
                    laiinComponents.Switch {
                        ...
                        radius: 13
                        backgroundCheckedColor: laiinComponents.Style.moneroOrangeColor
                        onToggled: settingsDialog.save()
                    }                
                }                            
    }
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    Layout.preferredHeight: 50
                    placeholderText: qsTr((isWindows) ? "monerod.exe" : "monerod"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                    color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                    selectByMouse: true
                ...
                TextField {
                    ...
                    placeholderText: qsTr(Backend.urlToLocalFile(defaultMoneroDataDirFolder)); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                    color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                    selectByMouse: true
                    readOnly: true
                ...
                RowLayout {
                    ...
                    TextField {
                        ...
                        Layout.preferredHeight: 50
                        placeholderText: qsTr((confirmExternalBindSwitch.checked) ? "0.0.0.0" : "localhost"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                        color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        selectByMouse: true
                ...
                RowLayout {
                    ...
                    TextField {
                        ...
                        Layout.preferredHeight: 50
                        placeholderText: qsTr("Daemon Username (optional)"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                        color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        selectByMouse: true
                    ...
                    TextField {
                        ...
                        Layout.preferredHeight: 50
                        placeholderText: qsTr("Daemon Password"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                        color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        selectByMouse: true
                ...
                /*TextField {
                        ...
                        Layout.preferredHeight: 50
                        placeholderText: qsTr("Daemon flags (optional)"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                        color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                        selectByMouse: true
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            color: laiinComponents.Style.moneroOrangeColor
                            radius: 3
                        }
                        contentItem: Text {
                            text: parent.text
                    ...
                    Button {
                        ...
                        enabled: Wallet.opened
                        background: Rectangle {
                            color: !localNodeConnectButton.enabled ? laiinComponents.Style.disabledColor : laiinComponents.Style.moneroOrangeColor
                            radius: 3
                        }
                        contentItem: Text {
                            text: parent.text
    ...
    FileDialog {
        ...
        folder: (isWindows) ? StandardPaths.writableLocation(StandardPaths.DocumentsLocation) + "/laiin" : StandardPaths.writableLocation(StandardPaths.HomeLocation) + "/laiin"
