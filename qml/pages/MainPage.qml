...
Page {
    ...
    function startWalletSync() {
        ...
        if(settingsDialog.moneroNodeType == 1) {
            ...
            Wallet.daemonExecute(settingsDialog.monerodPath, settingsDialog.confirmExternalBind, settingsDialog.restrictedRpc, settingsDialog.moneroDataDir, 0/*Script.getNumber("laiin.monero.wallet.restore_height")*/);
            Wallet.daemonConnect();//(moneroDaemonRpcLoginUser.text, moneroDaemonRpcLoginPwd.text)
        ...
        if(settingsDialog.moneroNodeType == 0) {
            ...
            Wallet.nodeConnect(remote_node_ip, remote_node_port)//, moneroDaemonRpcLoginUser.text, moneroDaemonRpcLoginPwd.text);//Wallet.nodeConnect(Script.getString("laiin.monero.daemon.ip"), Script.getString("laiin.monero.daemon.port"), moneroDaemonRpcLoginUser.text, moneroDaemonRpcLoginPwd.text);
            if(Wallet.isConnectedToDaemon()) {
                moneroDaemonSyncBar.title = settingsDialog.moneroNodeAddress
            }
        }
    ...
    FileDialog {
        ...
        folder: (isWindows) ? StandardPaths.writableLocation(StandardPaths.DocumentsLocation) + "/laiin/wallet" : StandardPaths.writableLocation(StandardPaths.HomeLocation) + "/laiin/wallet"//StandardPaths.writableLocation(StandardPaths.AppDataLocation) // refer to https://doc.qt.io/qt-5/qstandardpaths.html#StandardLocation-enum
    ...
    FolderDialog {
        ...
        folder: (isWindows) ? StandardPaths.writableLocation(StandardPaths.DocumentsLocation) + "/laiin/wallet" : StandardPaths.writableLocation(StandardPaths.HomeLocation) + "/laiin/wallet"
    }
    ///////
    StackLayout { // Perfect for a stack of items where only one item is visible at a time//ColumnLayout { // From top to bottom
        ...
        Rectangle {
            ...
            id: loginPage
            color: laiinComponents.Style.getColorsFromTheme()[0]
            //gradient: Gradient {
            ...
            Button {
                ...
                background: Rectangle {
                    color: "#121212"//"#6b5b95"//
                    radius: 100
                    border.color: parent.contentItem.color//(laiinComponents.Style.darkTheme) ? parent.contentItem.color : "#000000"
           ...
           // wallet file field
            TextField {
                ...
                color: "#000000"////(laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000" // textColor                
                selectByMouse: true
                readOnly: true
                
                background: Rectangle { 
                    color: "#708090"////(laiinComponents.Style.darkTheme) ? "#101010" : "#ffffff"
            ...
            Button {
                ...
                TextField {
                    ...
                    Layout.topMargin: 10
                    placeholderText: qsTr("Wallet Password"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                    color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000" // textColor
                    echoMode: TextInput.Password
                    inputMethodHints: Qt.ImhSensitiveData
                    selectByMouse: true
                
                    background: Rectangle { 
                        color: (laiinComponents.Style.darkTheme) ? "#101010" : "#ffffff"
                        border.color: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
               ...
               Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        ScrollView {
                            ...
                            TextArea {
                                ...
                                color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"                  
                                background: Rectangle {
                                    color: (laiinComponents.Style.darkTheme) ? "#101010" : "#f0f0f0"
                                    border.color: (laiinComponents.Style.darkTheme) ? "#404040" : "#4d4d4d"
                        ...
                        TextField {
                            ...
                            Layout.fillWidth: true
                            Layout.preferredHeight: 50
                            placeholderText: qsTr("Restore Height (default: 1580000)"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                            color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000" // textColor
                            selectByMouse: true
                ...
                Button {
                	...
                	contentItem: Text {  
                    	//font.family: "Consolas"; //font.family: laiinComponents.Style.fontFiraCodeLight.name
                    	//font.pointSize: 10
                    	font.bold: true
                        ...
                        ColumnLayout {
                            ...
                            Item {
                                ...
                                Column {
                                    ...
                                    TextField {
                                        ...
                                        height: 50
                                        placeholderText: qsTr("wallet"); placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                                        color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000" // textColor
                                        selectByMouse: true
                                        maximumLength: 255
                            ...
                            Item {
                                ...
                                Column {
                                    ...
                                    TextField {
                                        ...
                                        color: laiinComponents.Style.moneroOrangeColor // textColor
                                    ...
                                    TextField {
                                        ...
                                        placeholderTextColor: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
                                        color: walletPasswordField.color//laiinComponents.Style.moneroOrangeColor // textColor
                                        echoMode: (!walletPasswordVisibilityToggle.checked) ? TextInput.Normal : TextInput.Password
                                        inputMethodHints: Qt.ImhSensitiveData
                                        selectByMouse: true
                                        background: Rectangle { 
                                            color: walletPasswordField.background.color//laiinComponents.Style.moneroGrayColor
                            ...
                            Row {
                                ...
                                Button {
                                    ...
                                    background: Rectangle {
                                        color: laiinComponents.Style.moneroGrayColor
                                        radius: 5
                            ...
                            TextArea {
                                ...
                                color: (messageCode == 1) ? "#b22222" : ((laiinComponents.Style.darkTheme) ? "#ffffff" : "#404040")// text color
                                property int messageCode: 0 //0 = info; 1 = warning or error
                                background: Rectangle { 
                                    color: "transparent"
                                    border.color: (parent.messageCode == 1) ? "#b22222" : "#2196f3"////parent.color//(laiinComponents.Style.darkTheme) ? "#ffffff" : "#404040"
                                    radius: 3
                                }            
                    ...
                    Item {//Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            TextArea {
                                ...
                                background: Rectangle { 
                                    color: "transparent"
                                    border.color: (parent.messageCode == 1) ? "#b22222" : ((laiinComponents.Style.darkTheme) ? "#a9a9a9" : parent.color)////parent.color
                                    radius: 3
                                }            
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    FileDialog {
                        ...
                        fileMode: FileDialog.OpenFile
                        folder: (isWindows) ? StandardPaths.writableLocation(StandardPaths.DocumentsLocation) + "/laiin" : StandardPaths.writableLocation(StandardPaths.HomeLocation) + "/laiin"//StandardPaths.writableLocation(StandardPaths.AppDataLocation) // refer to https://doc.qt.io/qt-5/qstandardpaths.html#StandardLocation-enum
            	...
            	TextField {
                	...
                	color: "#6b5b95"////(laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000" // textColor
                	selectByMouse: true
                	background: Rectangle { 
                        color: (laiinComponents.Style.darkTheme) ? "#101010" : "#ffffff"
                        border.color: (laiinComponents.Style.darkTheme) ? "#a9a9a9" : "#696969"
