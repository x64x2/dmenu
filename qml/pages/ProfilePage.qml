...
Page {
    ...
    ColumnLayout {
        ...
        Button {
            ...
            background: Rectangle {
                radius: 5
                color: backButton.hovered ? laiinComponents.Style.laiinPurpleColor : "#50446f"
            }
            onClicked: {
                pageStack.goBack()
            }
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        radius: 5
                        border.width: 7
                        border.color: laiinComponents.Style.getColorsFromTheme()[1]//"#343434"//"#808080"//"#0e0e11"//"#000000"//"#ffffff"
                    ...
                    Column {
                        ...
                        TextArea {
                            ...
                            font.pixelSize: 16
                            //font.bold: true
                            color: (laiinComponents.Style.darkTheme) ? "#d0d0d0" : "#464646"
                            readOnly: true
                    ...
                    Row {
                        ...
                        property string buttonColor: infoRect.color//laiinComponents.Style.laiinPurpleColor
                        ...
                        Row {
                            ...
                            Row { // place thumbs in this row
                                ...
                                Rectangle {
                                    ...
                                    id: reputationRect
                                    width: 100; height: 32
                                    color: (laiinComponents.Style.darkTheme) ? "#101010" : "#efefef"
                                    border.color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                                    radius: 3
            ...
            Rectangle {
                ...
                color: "royalblue"//laiinComponents.Style.laiinPurpleColor//infoRect.color
        ...
        StackLayout {
            ...
            currentIndex: 0
            property string tabItemColor: laiinComponents.Style.getColorsFromTheme()[1]//"#101010"//laiinComponents.Style.getColorsFromTheme()[0]//"transparent"//""
            Rectangle {
                id: listingsTabItem
                ...
                GridView {
                    ...
                    delegate: Rectangle {
                        ...
                        color: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#17171c" : "#181a1b") : "#c9c9cd"//"transparent"
                ...
                Flickable {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            color: "transparent"//(laiinComponents.Style.darkTheme) ? "#101010" : "#efefef"//index % 2 === 0 ? "#f0f0f0" : "#e0e0e0"
                            radius: 6
                            property string textColor: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
