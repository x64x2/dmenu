            ...
            Rectangle {
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Rectangle {
                            anchors.fill: parent
                            color: parent.ListView.isCurrentItem ? ((laiinComponents.Style.darkTheme) ? ((laiinComponents.Style.themeName == "PurpleDust") ? "#3a3a46" : "#3c4143") : "#d7d7da") : "transparent"
                        ...
                        Item {
                            ...
                            RowLayout { // By default this should inherit its children rect size
                                ...
                                Text {
                                    ...
                                    color: parent.parent.parent.ListView.isCurrentItem ? "#7d6b9a" : ((laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000")
                        ...
                        MouseArea {
                            ...
                            hoverEnabled: true
                            onEntered: {
                                parent.color = (laiinComponents.Style.darkTheme) ? ((laiinComponents.Style.themeName == "PurpleDust") ? "#3a3a46" : "#3c4143") : "#d7d7da"
                            }
                            onExited: {
