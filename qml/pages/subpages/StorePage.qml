...
Page {
    ...
    laiinComponents.TabBar {
        ...
        Component.onCompleted: {
            buttonAt(0).checked = true : make "Inventory" default tab for quicker access to listing products
        }
    }
            ...
            ScrollView {
                ...
                ColumnLayout {                
                    ...
                    RowLayout {
                        ...
                        property string textColor: "#384364"////(laiinComponents.Style.darkTheme) ? "#ffffff" : "#384364"
                        ...
                        property string boxColor: "#ffffff"////(laiinComponents.Style.darkTheme) ? "#384364" : "#ffffff"
                        // Products (listed)
                        Rectangle {
            ...
            ScrollView {
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        Row { // Row 1 (left)
                            ...
                            /*laiinComponents.ComboBox {
                                ...
                                onActivated: {
                                    ...
                                    if(currentIndex == find("Date")) {
                                        inventoryTable.list.model = User.inventoryDate//User.getInventory(laiin.SortByDateOldest)
                                    }
                                }
                            }*/
                            ...
                            Frame {
                                ...
                                background: Rectangle {
                                    color: "transparent"
                                    border.color: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#17171c" : "#181a1b") : "#bdbdbd"////"#c9c9cd" // default frame border color is "#bdbdbd"
                                    radius: 2
                                }
                                Row {
                                    anchors.fill: parent
                                    ...
                                    Button {
                                        ...
                                        icon.color: "#b22222"
                                        background: Rectangle {
                                            color: parent.hovered ? ((laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#17171c" : "#181a1b") : "#c9c9cd") : "transparent"
                                            radius: 5
                                        }
                    ...
                    laiinComponents.CheckBox {
                        ...
                        shapeType: laiinComponents.CheckBox.ShapeType.Block
                    ...
                    Frame {      
                        ...
                        background: Rectangle {
                            radius: 3
                            color: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#17171c" : "#181a1b") : "#c9c9cd"
                            border.color: inventoryTable.columnBorderColor
                        }
                        laiinComponents.InventoryTable {
                            id: inventoryTable
                            width: parent.width
                        }
                    }
                    // ProductDialog popup
                    laiinComponents.ProductDialog {
                        id: productDialog
                        anchors.centerIn: Overlay.overlay////parent
                    }
                    // RemoveProduct message prompt
                    laiinComponents.MessageBox {
