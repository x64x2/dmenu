...
Page {
    ...
    ColumnLayout {
        ...
        property string baseColor: (laiinComponents.Style.darkTheme) ? (laiinComponents.Style.themeName == "PurpleDust" ? "#0e0e11" : "#101010") : "#f0f0f0"
        property string borderColor: (laiinComponents.Style.darkTheme) ? "#404040" : "#4d4d4d"
        ...
        laiinComponents.TabBar {
            ...
            color0: laiinComponents.Style.moneroOrangeColor
            ...
            Item {
                ...
                Flickable {
                    ...
                    Column {
                        ...
                        Button {
                            ...
                            text: qsTr("Transfer")
                            background: Rectangle {
                                color: parent.hovered ? "#ff7214" : laiinComponents.Style.moneroOrangeColor
                                radius: balanceTxColumn.radius
                            }
                            contentItem: Text {
                                text: parent.text
                ...
                laiinComponents.MessageBox {
                    ...
                    Component.onCompleted: {
                        ...
                        buttonAt(0).color = laiinComponents.Style.moneroGrayColor
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            Button {
                                ...
                                icon.color: (laiinComponents.Style.darkTheme) ? "#ffffff" : "#000000"
                                background: Rectangle {
